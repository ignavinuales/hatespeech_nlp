...
# Import data
df = pd.read_csv('Dataset/measuring_hate_speech.csv')
...
checkpoint = callbacks.ModelCheckpoint(filepath='Models/LSTM_checkpoint.h5', monitor='val_loss', verbose=0, save_best_only=True, save_freq='epoch')
